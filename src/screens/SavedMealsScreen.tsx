  ...
  return (
    <main className="screen-enter space-y-7">
      ...
      <section className="section-enter">
        ...
        <p className="mt-3 text-[16px] font-medium leading-[1.45] text-ink-soft">Everything you liked, cooked, or shopped for. Swipe left to delete.</p>
      </section>
...
function SavedMealCard({
  ...
  return (
    <SwipeToDelete label={meal.name} onDelete={onRemove} className="rounded-lg">
      <Card>
